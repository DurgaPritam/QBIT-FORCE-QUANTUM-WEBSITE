...
import { CaptionField, emptyGallery, SortOrderField, TitleField } from "./adminFormDefaults";
...
export default function AdminGallery() {
  ...
  const { items, error, reload, setError } = useAdminList<GalleryItem>("/admin/gallery", refreshKey);
